"""Windows screen capture backend using mss."""
...
class PyGetWindowScreenCapture(ScreenCaptureBackend):
    """Windows screen capture using mss with pygetwindow for monitor info."""
    ...
    def _build_engine(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Windows ScreenCapture rebuilt OK: {self.monitor_count} monitor(s)"
            )
            return True
