...
def main():
    ...
    parser.add_argument("--host", default="0.0.0.0")
    parser.add_argument("--port", type=int, default=8008)
    parser.add_argument("--fps", type=int, default=60, help="Frame rate: 1-60 (default: 60 for maximum responsiveness)")
...
class MouseWorker(threading.Thread):
    def __init__(self):
        ...
        self.current_x = self.screen_w / 2
        self.current_y = self.screen_h / 2
        self.smoothing = 0.55  # Increased from 0.3 for more direct/responsive feel (less lag)
        self.min_step = 1.0
        self.mouse_down_state = {}
